...
import ApplicationStatus from "../../components/sale-and-confirm/ApplicationStatus/components/ApplicationStatusToSetCategory/ApplicationStatusToSetCategory";
import SaleFormRouter from "../SaleFormRouter/SaleFormRouter";
import DamagedFormContainer from "../DamagedForms/DamagedFormContainer";
    ...
    <div className={styles.main_content}>
      ...
      >
        <Routes>
          ...
          <Route path="status/:applicationNo/:status" element={<SaleFormRouter />} />
          <Route
            path="status"
            element={<ApplicationStatus key={location.pathname} />}
          />
          <Route path="damage" element={<DamagedFormContainer/>} />
